...
// ← all paths prefixed with /student/ to match App.jsx mount point
const NAV = [
  ...
  return (
    <>
      ...
      >
            ...
            return (
              <Link key={to} to={to} onClick={onClose} style={{ textDecoration: "none" }}>
                <div
                  ...
                  style={{ background: active ? "rgba(136,189,242,0.15)" : "transparent", cursor: "pointer" }}
                ...
                >
                  ...
                  <span
                    className="text-sm"
                    style={{ color: active ? "#e8f4fd" : "#8fafc4", fontWeight: active ? 600 : 400, fontFamily: "'Inter', sans-serif" }}
                  >
                    {label}
                  </span>
                  {active && (
                    <span className="ml-auto w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: "#88BDF2" }} />
                  )}
                </div>
              </Link>
            );
        ...
        {/* User card */}
        <div className="px-3 py-3 flex-shrink-0" style={{ borderTop: "1px solid rgba(136,189,242,0.12)" }}>
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl" style={{ background: "rgba(136,189,242,0.08)" }}>
            <div
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold truncate" style={{ color: "#e8f4fd", fontFamily: "'Inter', sans-serif" }}>
                {displayName}
              </p>
              <p className="text-[11px] truncate" style={{ color: "#6A89A7", fontFamily: "'Inter', sans-serif" }}>
                {displayRole}
              </p>
            </div>
          </div>
