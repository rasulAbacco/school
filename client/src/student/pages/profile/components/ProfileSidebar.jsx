...
export default function ProfileSidebar({ profileData, enrollment, parents, loading }) {
  ...
  const avatarImage = useMemo(() => {
    ...
    return IMAGE_LIST[hash % IMAGE_LIST.length];
  ...
  return (
    <div className="pf-sidebar">
      ...
      <div style={{
        width: "100%",
        // Aspect-ratio box: tall enough to show full figure, never clips
        aspectRatio: "3 / 4",
        maxHeight: 320,
        minHeight: 200,
        position: "relative",
        ...
        {numericGrade < 5 ? (
          ...
          /* Avatar3D fills the container; camera/target set in Avatar3D.jsx */
