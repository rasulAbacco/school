          ...
          <div className="grid grid-cols-7 gap-2">
            ...
            {monthlyAttendance.map((item, index) => (
              <div key={index} className="aspect-square">
                <div
                  className={`h-full rounded-lg ${getStatusColor(item.status)} flex flex-col items-center justify-center text-white font-semibold text-sm hover:scale-105 transition cursor-pointer`}
                >
                  <span>{item.date}</span>
                </div>
              </div>
          ...
          <div className="mt-6 space-y-3">
            <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
              ...
              <p className="text-green-600 text-xs mt-1">
                You're maintaining great attendance
              </p>
            </div>
            ...
            {attendanceStats.absent > 0 && (
              <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded">
                ...
                <p className="text-yellow-600 text-xs mt-1">
                  You have {attendanceStats.absent} absent day(s) this month
                </p>
              </div>
            )}
          </div>
