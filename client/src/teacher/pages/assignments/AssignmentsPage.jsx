// client/src/teacher/pages/assignments/AssignmentsPage.jsx
  ...
  import QuestionBuilderModal from "./QuestionBuilderModal.jsx";
          ...
          {loading ? (
            ...
            <div className="asgn-grid fade-up">
              ...
              <AssignmentCard
                ...
                onManageQuestions={() => setQuestionTarget(a)}
                ...
                onViewSubmissions={() =>
                  navigate(
                    `/teacher/assignments/${a.id}/submissions`
                  )
                }
              />
              ))}
      ...
      <div className="asgn-card" style={{
        ...
        {/* actions */}
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            ...
            >
              <HelpCircle size={13} color={C.slate} />
            </button>
