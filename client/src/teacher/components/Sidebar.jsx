            ...
            return (
              <Link key={to} to={to} onClick={onClose} style={{ textDecoration: "none" }}>
                ...
                >
                  ...
                  <span
                    className="text-sm"
                    style={{ color: active ? "#e8f4fd" : "#8fafc4", fontWeight: active ? 600 : 400, fontFamily: "'DM Sans', sans-serif" }}
                  >
                    {label}
                  </span>
                  {active && (
        ...
        <div className="px-3 py-3 flex-shrink-0" style={{ borderTop: "1px solid rgba(136,189,242,0.12)" }}>
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl" style={{ background: "rgba(136,189,242,0.08)" }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] truncate" style={{ color: "#6A89A7", fontFamily: "'DM Sans', sans-serif" }}>
                {displayRole}
              </p>
            </div>
          </div>
