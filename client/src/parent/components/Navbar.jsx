// client/src/parent/components/Navbar.jsx
// UI: Stormy Morning palette matching student Navbar.jsx
// Logic: 100% unchanged — getAuth, navigate, LogoutButton, dropdown, modal all intact
...
function Navbar({ onMenuClick }) {
  ...
  const handleLogoutClick = () => { setIsDropdownOpen(false); setIsLogoutModalOpen(true); };
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="hidden md:block text-right">
                <p className="text-sm font-semibold leading-tight" style={{ color: "#384959" }}>{parentName}</p>
                <p className="text-[11px]" style={{ color: "#6A89A7" }}>PARENT</p>
              </div>
              ...
              <ChevronDown
                size={14}
                className={`hidden md:block transition-transform duration-200 ${isDropdownOpen ? "rotate-180" : ""}`}
                style={{ color: "#6A89A7" }}
              />
            </button>
              ...
              >
                ...
                <div className="flex items-center gap-2.5 px-4 py-3 mb-1" style={{ borderBottom: "1px solid #f1f5f9" }}>
                  ...
                  <div className="min-w-0">
                    <p className="text-xs font-semibold truncate" style={{ color: "#384959" }}>{parentName}</p>
                    <p className="text-[10px] truncate" style={{ color: "#6A89A7" }}>PARENT</p>
                  </div>
                </div>

                <button
                  onClick={() => { setIsDropdownOpen(false); navigate("/parent/profile"); }}
