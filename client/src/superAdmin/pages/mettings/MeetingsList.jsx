// client/src/superAdmin/pages/meeting/MeetingsList.jsx
import React, { useState, useEffect, useCallback } from "react";
import { Search, RefreshCw, CalendarDays, Loader2, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <tr><td colSpan={8}>
      <div style={{ padding: "60px 20px", textAlign: "center", fontFamily: "'Inter', sans-serif" }}>
        ...
        <p style={{ margin: "5px 0 16px", fontSize: 12, color: C.textLight }}>No meetings match the current filters</p>
      </div>
    </td></tr>
  );
}
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "'Inter', sans-serif" }}>
              ...
              <tbody>
                {loading ? (
                  ...
                  meetings.map((m) => (
                    <MeetingTableRow key={m.id} meeting={m} onView={setViewMeeting} onDelete={setDeleteTarget} />
                  ))
                )}
              </tbody>
            </table>
