// src/superAdmin/pages/chat/components/SuperAdminMessageView.jsx
...
const SuperAdminMessageView = ({ selectedChat, onBack }) => {
  const user = getUser();
        ...
        {selectedChat ? (
          <>
            ...
            <div className="p-3 border-t-[1.5px] border-blue-200 bg-white flex items-center gap-2 flex-shrink-0">
              ...
              />
              <button
                className="bg-green-600 text-white border-none rounded-full w-10 h-10 flex items-center justify-center cursor-pointer flex-shrink-0 hover:bg-green-700 transition-colors disabled:opacity-40"
                onClick={handleSend}
...
export default SuperAdminMessageView;